...
# Input files:
data_filename="/proj/BigLearning/jinlianw/data/netflix.dat.list.gl.perm.bin.1"
...
num_iterations=100
# number of computation threads to use
...
# output paths
output_dir="$app_dir/output_nsdi17.n16"
output_dir="${output_dir}/${progname}"
