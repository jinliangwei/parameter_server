...
bg_idle_milli=2
server_idle_milli=2
client_bandwidth_mbps=80
server_bandwidth_mbps=80
thread_oplog_batch_size=10000
...
app_output_dir=${app_root}/output_${consistency_model}_${num_work_units}
...
app_output_dir=${app_output_dir}_${client_send_oplog_upper_bound}_${num_comm_channels_per_client}_${num_clocks_per_work_unit}_16
