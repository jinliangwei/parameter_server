...
app_output_dir=${app_root}/nytimes/output_${consistency_model}_${num_work_units}
...
doc_filename="/l0/clueweb"
doc_filename="/proj/BigLearning/jinlianw/data/processed/nytimes.1"
