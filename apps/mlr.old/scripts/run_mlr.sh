...
num_test_eval=1000
num_secs_per_checkpoint=2000000
...
client_bandwidth_mbps=1280
server_bandwidth_mbps=1280
...
output_dir="${app_dir}/output_mar_8_x1"
...
output_dir="${output_dir}.CBW${client_bandwidth_mbps}.S${server_bandwidth_mbps}"
